##
## Augmented-Dickey-Fuller Test that stores optimal lags
##
ur.df.ol <- function (y, type = c("none", "drift", "trend"), lags = 1, selectlags = c("Fixed", "AIC", "BIC"))
{
  ...
  new("ur.df.ol", y = y, model = type, cval=cvals, lags=lag, optilags = optimaxlags,
